...
public interface ApplicationRepository extends JpaRepository<ApplicationEntity, Long> {
    ...
    @Query("SELECT entity FROM ApplicationEntity entity WHERE entity.id = :id AND entity.deleted = :deleted AND entity.user.username = :username")
    Optional<ApplicationEntity> findByIdAndDeletedAndUser(long id, boolean deleted, String username);
